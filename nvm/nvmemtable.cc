...
class NvmemTableIterator: public Iterator {
 public:
  ...
  virtual void SeekToLast() {  
      std::__throw_runtime_error( "MemTableIterator's SeekToLast() is not implemented ! \n");
  }
  virtual void Next() {  ++iter_; }
  virtual void Prev() { 
    std::__throw_runtime_error( "MemTableIterator's Prev() is not implemented ! \n");
  }
  virtual Slice key() const {  
     return GetLengthPrefixedSlice((char *)(iter_.value())); 
  }
  virtual Slice value() const {
    Slice key_slice = GetLengthPrefixedSlice((char *)(iter_.value()));
